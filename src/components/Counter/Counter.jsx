...
const Counter = ({product}) => {
    ...
    const {aTCart} = useContext(TiendaContext)
    ...
    const addToCart = () => {
        ...
        if (items > product.stock) {
            alert ('No hay cantidades suficientes')
            return false
        }
        ...
        <div className='counter my-4'>
            ...
            <div className="counter_cart d-flex justify-content-start align-items-center">
                ...
                <div className="w-100 d-flex align-items-center counter_item">
                    ...
                    <i 
                        className="far fa-minus-square plus"
                        onClick={removeItems}></i>

                    <input
                        type='number' 
                        className="counter_input p-1"
                        value={items}
            ...
            <div className="mt-4 align-items-center w-100">

                {
                    ...
                    (
                        <div className="">
                            <Link to='/cart'>
                                <button className="btn btn-outline-primary text-uppercase my-2 px-4 w-100">Finalizar compra</button>
                            </Link>

                            <Link to='/'>
                                <button className="btn btn-outline-secondary text-uppercase my-2 px-4 w-100">Continuar compra</button>
                            </Link>
                        </div>
                    ) :
                    (
                        <button 
                            className="btn btn-primary text-uppercase my-2 px-4 w-100" 
